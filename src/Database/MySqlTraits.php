...
trait MySqlTraits
{
     ...
     * @return PDOStatement|MySql Returns MySql Object if dryrun is true, else returns PDOStatement
     */
     ...
     */
    public function execute(string $sql, array $params = [], bool $dryrun = false): MySql|int
    {
